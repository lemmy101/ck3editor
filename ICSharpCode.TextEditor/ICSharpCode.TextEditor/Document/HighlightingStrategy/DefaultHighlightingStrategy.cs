...
namespace ICSharpCode.TextEditor.Document
{
    public class DefaultHighlightingStrategy : IHighlightingStrategyUsingRuleSets
	{
		...
		public Dictionary<string, HighlightColor> environmentColors = new Dictionary<string, HighlightColor>();
		...
		public DefaultHighlightingStrategy(string name, bool red=false)
		{
			...
			*/
            ...
            environmentColors["CaretMarker"] = new HighlightColor(Color.Yellow, true, false);
