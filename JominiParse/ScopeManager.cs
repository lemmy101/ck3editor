...
namespace JominiParse
{
    ...
    public class ScopeTypeDef
    {
        ...
        public Dictionary<string, ScopeChangeDefinition> ValidTriggerScopes =
            new Dictionary<string, ScopeChangeDefinition>();

        public Dictionary<string, ScopeChangeDefinition> ValidEffectScopes =
            new Dictionary<string, ScopeChangeDefinition>();
